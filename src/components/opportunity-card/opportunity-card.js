  ...
  return (
    <div className='opportunity-card' >
      <div className='opportunity-img-wrapper'>
        ...
        {isLoading ? 
        <ReactPlayer url={video} width="100%" height="35vh" playing={true}   />  
        : <div style={{'position':'relative'}}>
         ...
         <img className='opportunity-img' src={pitch_video} alt={project_title} />
         </div>
             }
        </div>
        : <img className='opportunity-img' src={project_image} alt={project_title} />
      }
